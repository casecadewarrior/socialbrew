  ...
  export default function Dashboard() {
    return (
      <div className="bg-white">
        <div className="max-w-2xl mx-auto md:py-16 md:px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
          <div className="grid grid-cols-1 md:gap-y-10 md:gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
